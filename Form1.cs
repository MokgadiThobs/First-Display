...
namespace First_Display
{
    public partial class Form1 : Form
    {
        ...
        private void btnMortgage_Click(object sender, EventArgs e)
        {
            ...
            // Display the result
            label5.Text = String.Format("Monthly Payment: R {0}", monthlyPayment.ToString());
        }
        ...
        private void btnAuto_Click(object sender, EventArgs e)
        {
            ...
            int termsinMonths = terms * 12; interestRate /= 12; monthlyPayment = (interestRate * loanAmount) / (1 - Math.Pow(1 + interestRate, termsinMonths * -1));
            monthlyPayment = Math.Round(monthlyPayment, 2);
